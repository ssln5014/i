...
const add_id = "afmnraekkilmvkh1"; // app_id
const app_secret = "Y3c3Vk1TM3NMRUNCWWM5eGYzS3pRUT09"; // app_secret
const key = "05601705b2404024ba953b9cb08852ca" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("To the time to life, rather than to life in time");
        $("#change1").html("我想，当风吹过的时候，我可以拥抱这个世界");
    }
});
